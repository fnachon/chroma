...
"""Reusable graph-design encoder, decoder, and traversal components."""
        ...
        **kwargs
        ...
        self.config, self.extra_kwargs = build_model_config(
            BackboneEncoderGNNConfig,
            {
                ...
                "dropout": dropout,
                "graph_distance_atom_type": graph_distance_atom_type,
                "graph_cutoff": graph_cutoff,
                "graph_mask_interfaces": graph_mask_interfaces,
